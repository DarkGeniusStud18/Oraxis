      ...
      <DialogContent className="sm:max-w-3xl">
        ...
        <ScrollArea className="h-[60vh] mt-4 pr-4">
          <div className="space-y-6">
            ...
            <section>
              <h3 className="font-semibold text-lg mb-2">4. Cookies and Tracking Technologies</h3>
              <p className="text-muted-foreground mb-3">
            ...
            <section>
              <h3 className="font-semibold text-lg mb-2">5. Data Sharing and Disclosure</h3>
              <p className="text-muted-foreground mb-3">
            ...
            <section>
              <h3 className="font-semibold text-lg mb-2">7. Your Data Protection Rights</h3>
              <p className="text-muted-foreground mb-3">
